...
1.Hugging Face model integration — evaluate and integrate stronger vision models
from the Hugging Face ecosystem and move beyond the current zero-shot CLIP approach.

2.F1-specific dataset and fine-tuning — build a human-verified dataset from
...
3.Track-condition intelligence — improve detection of surface wetness, standing
...
8.Multimodal race analysis — combine video, telemetry, weather, historical race
...
9.Uncertainty-aware predictions — preserve the system's ability to refuse unreliable
...
F1 Telemetry + Circuit Intelligence + Tyre Strategy into a single system capable of analysing racing footage and producing an
